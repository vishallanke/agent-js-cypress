...
class Reporter {
  ...
  suiteEnd(suite) {
    ...
    console.log("Inside suiteEnd suiteId ", suiteId , suiteTestCaseId, suiteStatus)
  ...
  testStart(test) {
    console.log("Inside testStart test.parentId ", test.parentId)
  ...
  sendLogOnFinishItem(test, tempTestId) {
    console.log("Inside sendLogOnFinishItem test.status " , test.status)
  ...
  testEnd(test) {
    console.log("Inside testEnd test.id " , test.id)
