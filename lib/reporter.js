...
class Reporter {
  ...
  suiteStart(suite) {
    ...
    console.log("Inside suiteStart END")
  ...
  suiteEnd(suite) {
    ...
    console.log("Inside suiteEnd END")
  ...
  testStart(test) {
    ...
    console.log("Inside testStart END")

  }

  sendLogOnFinishItem(test, tempTestId) {
    console.log("Inside sendLogOnFinishItem")
  ...
  testEnd(test) {
    ...
    this.currentTestTempInfo = null;
    console.log("Inside testEnd END")
